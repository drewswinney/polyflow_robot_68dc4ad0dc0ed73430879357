...
let
  ...
  password = "password";
  interface = "end0";
  hostname = "68dc4ad0dc0ed73430879357";
in {
  nixpkgs.overlays = [
    (final: super: {
  ...
  systemd.services.polyflow_startup = {
    ...
    serviceConfig = {
      ...
      DIRECTORY="/home/${user}/polyflow_robot_68dc4ad0dc0ed73430879357"
      if [[ -d "$DIRECTORY" ]];
        then
          cd "$DIRECTORY"
          ...
          ${pkgs.git}/bin/git clone https://github.com/drewswinney/polyflow_robot_68dc4ad0dc0ed73430879357.git
          chown -R ${user}:users /home/${user}/polyflow_robot_68dc4ad0dc0ed73430879357
          cd polyflow_robot_68dc4ad0dc0ed73430879357/workspace
